...
class ApiService {
  ...
  static Future<Map<String, dynamic>> getRefugee(String id) async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/refugees/$id'));
  ...
  static Future<Map<String, dynamic>> getShelter(String id) async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/shelters/$id'));
  ...
  static Future<List<Map<String, dynamic>>> getAvailableShelters() async {
    try {
      final response = await http.get(Uri.parse('$baseUrl/shelters/available'));
